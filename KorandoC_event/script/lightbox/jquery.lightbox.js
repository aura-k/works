        ...
        if (type=='image') {
          ...
          image.onload = $.proxy(function() {
            ...
            this.esqueleto.background.bind('complete', $.proxy(function() {
              ...
              if (options.title != '') {
                this.esqueleto.background.append($('<div class="'+this.options.name+'-title"></div>').html("<a href='" + image.src.substring(0, image.src.length - 4) + ".zip' target='_blank'>"+options.title+"</a>"));
              }
