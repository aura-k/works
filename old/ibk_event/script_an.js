function allFadeOut(sec){
	...
	$('.hidden5').attr('style', '-webkit-transform:translate(0px, 0px);');
	$('.hidden0').fadeOut(sec);
	$('.hidden1').fadeOut(sec);
	$('.hidden2').fadeOut(sec);
...
function nextLogic(row, col){
	$('#game').attr('style', '-webkit-transform:translate(-' + (row * 320) + 'px, -' + ((col * 508) - 508) + 'px);');
}
function nextLogic2(row, col){
	$('.hidden5').attr('style', '-webkit-transform:translate(-' + (row * 320) + 'px, -' + ((col * 508) - 508) + 'px);');
}