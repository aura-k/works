...
#xeAdmin div.infoText p.warning{ margin:0 0 10px 0; padding:0 0 0 25px; background:url(/xe/modules/admin/tpl/img/iconWarning.gif) no-repeat left top;}
#xeAdmin div.infoText p.update{ margin:0 0 10px 0; padding:0 0 0 25px; background:url(/xe/modules/admin/tpl/img/iconRefresh.gif) no-repeat left top;}
