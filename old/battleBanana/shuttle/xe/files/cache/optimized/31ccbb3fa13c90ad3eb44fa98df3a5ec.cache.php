...
.crossTable thead th{ border-top:2px solid #cfcfcf; border-bottom:1px solid #e5e5e5; background-image:url(/xe/modules/admin/tpl/img/lineVrText.gif); background-repeat:no-repeat; background-position:left center;}
...
.colTable th{ border-top:2px solid #cfcfcf; border-bottom:1px solid #e5e5e5; background:#f4f4f4; background-image:url(/xe/modules/admin/tpl/img/lineVrText.gif); background-repeat:no-repeat; background-position:left center;}
...
.e1 .navigation li a{ display:block; position:relative; padding:4px 0 4px 24px; background-image:url(/xe/modules/admin/tpl/img/iconNavigation.gif); background-repeat:no-repeat;}
...
.e2 .section h3.xeAdmin .date{ padding-left:10px; background:url(/xe/modules/admin/tpl/img/lineVrText.gif) no-repeat left center;}
...
#xeAdmin .localNavigation li a{ float:left; padding:7px 15px 0 15px; height:18px; border:1px solid #ddd; border-bottom:none; background:url(/xe/modules/admin/tpl/img/bgTab.gif) repeat-x;}
#xeAdmin .localNavigation li.on { margin-bottom:-1px;}
#xeAdmin .localNavigation li.on a{ height:19px; background:none;}

#xeAdmin h3.xeAdmin {border-bottom:2px solid #ccc; padding:5px 0 5px 25px; margin:0 0 10px 0; background:url(/xe/modules/admin/tpl/img/iconH2.gif) no-repeat left center;}
#xeAdmin h4.xeAdmin {padding:5px 0 5px 20px; background:url(/xe/modules/admin/tpl/img/iconH3.gif) no-repeat left center;}
...
.layer .xButton { position:absolute; top:9px; right:9px; width:15px; height:14px; background-color:transparent; background:url(/xe/modules/admin/tpl/img/buttonClose.gif) no-repeat; border:0; cursor:pointer; overflow:hidden; }
...
.boxModelControler .dragAble { position:relative; padding:15px 0 0 15px; background:url(/xe/modules/admin/tpl/img/bgRuler.gif) no-repeat; *zoom:1; cursor:move;}
.boxModelControler .dragAble .prevGrid { position:relative; margin:-1px; background:url(/xe/modules/admin/tpl/img/bgGrid.gif) 0 0; border:1px solid #000; *zoom:1;}
...
.boxModelControler .boxModelTable th.width { background-image:url(/xe/modules/admin/tpl/img/exWidth.gif); }
.boxModelControler .boxModelTable th.margin { background-image:url(/xe/modules/admin/tpl/img/exMargin.gif); }
.boxModelControler .boxModelTable th.padding { background-image:url(/xe/modules/admin/tpl/img/exPadding.gif); }
.boxModelControler .boxModelTable th.border { background-image:url(/xe/modules/admin/tpl/img/exBorder.gif); }
.boxModelControler .boxModelTable th.bgColor { background-image:url(/xe/modules/admin/tpl/img/exBgColor.gif); }
.boxModelControler .boxModelTable th.bgImage { background-image:url(/xe/modules/admin/tpl/img/exBgImage.gif); }
...
.boxModelControler .colorPicker .palette li button.transparent { background:url(/xe/modules/admin/tpl/img/bgNone.gif) no-repeat right top; border:1px solid #ddd; }
...
#popup_content .xButton { position:absolute; top:9px; right:18px; width:15px; height:14px; padding:0; background-color:transparent; background:url(/xe/modules/admin/tpl/img/buttonClose.gif) no-repeat; border:0; cursor:pointer; overflow:hidden; }
...
.adminTable caption { background:url(/xe/modules/admin/tpl/img/n_caption_head.gif) no-repeat left top; padding:8px 0 5px 30px; text-align:left; font-weight:bold !important; color:#FFFFFF !important; background-color:#888 !important; border-bottom:1px solid #FFFFFF; font-size:12px !important;}
...
.adminTable tr td.paper { background:transparent url(/xe/modules/admin/tpl/img/n_paper_bullet.gif) no-repeat 6px 8px; padding-left:20px; }
.adminTable tr.row2 td.paper { background:#F3F3F3 url(/xe/modules/admin/tpl/img/n_paper_bullet.gif) no-repeat 6px 8px; padding-left:20px; }
.adminTable tr td.circle { background:#FFFFFF url(/xe/modules/admin/tpl/img/n_circle_bullet.gif) no-repeat 6px 8px; padding-left:20px; }
.adminTable tr.row2 td.circle { background:#F3F3F3 url(/xe/modules/admin/tpl/img/n_circle_bullet.gif) no-repeat 6px 8px; padding-left:20px; }
...
.adminTable tr td.modify a { width:14px; height:14px; overflow:hidden; display:block; font-size:1px; line-height:100px; background:url(/xe/modules/admin/tpl/img/n_icon_modify.gif) no-repeat left top; }
.adminTable tr td.delete a { width:14px; height:14px; overflow:hidden; display:block; font-size:1px; line-height:100px; background:url(/xe/modules/admin/tpl/img/n_icon_delete.gif) no-repeat left top; }
.adminTable tr td.copy a { width:16px; height:16px; overflow:hidden; display:block; font-size:1px; line-height:100px; background:url(/xe/modules/admin/tpl/img/n_icon_copy.gif) no-repeat left top; }
.adminTable tr td.view a { width:14px; height:14px; overflow:hidden; display:block; font-size:1px; line-height:100px; background:url(/xe/modules/admin/tpl/img/n_icon_view.gif) no-repeat left top; }
.adminTable tr td.setup a { width:16px; height:16px; overflow:hidden; display:block; font-size:1px; line-height:100px; background:url(/xe/modules/admin/tpl/img/n_setup.gif) no-repeat left top; }
.adminTable tr td.activated a { width:16px; height:16px; overflow:hidden; display:block; font-size:1px; line-height:100px; background:url(/xe/modules/admin/tpl/img/n_light_on.gif) no-repeat left top; }
.adminTable tr td.deactivated a { width:16px; height:16px; overflow:hidden; display:block; font-size:1px; line-height:100px; background:url(/xe/modules/admin/tpl/img/n_light_off.gif) no-repeat left top;   }
.adminTable tr td.selectAll a { width:16px; height:16px; overflow:hidden; display:block; font-size:1px; line-height:100px; background:url(/xe/modules/admin/tpl/img/n_icon_select_all.gif) no-repeat left top; }
.adminTable tr td.deSelectAll a { width:16px; height:16px; overflow:hidden; display:block; font-size:1px; line-height:100px; background:url(/xe/modules/admin/tpl/img/n_icon_remove.gif) no-repeat left top; }
.adminTable tr td.moveupdown a.up { float:left; width:14px; height:14px; overflow:hidden; display:block; font-size:1px; line-height:100px; background:url(/xe/modules/admin/tpl/img/n_button_up.gif) no-repeat left top; margin-right:5px; }
.adminTable tr td.moveupdown a.down{ float:left; width:14px; height:14px; overflow:hidden; display:block; font-size:1px; line-height:100px; background:url(/xe/modules/admin/tpl/img/n_button_down.gif) no-repeat left top; }
...
.serverresponse { background: #FFFFFF url(/xe/modules/admin/common/tpl/images/loading.gif) no-repeat scroll 5px 5px; height:30px; padding-left:25px; padding-top:5px;  }
...
#search_nav button { padding:0; border:0; height:17px; width:17px; background:transparent url(/xe/modules/admin/tpl/img/buttonSearch.gif) no-repeat center; vertical-align:middle;}
#search_nav button.close {background:transparent url(/xe/modules/admin/tpl/img/buttonClose.gif) no-repeat center;}
