...
.xeEditor { }
.xeEditor .optionABC { clear:both; width:100%; border-bottom:1px solid #c2c2c2; overflow:hidden; background:#ffffff url(/xe/modules/editor/tpl/images/bgBoardEditorOption.gif) no-repeat -3px bottom;}
...
.xeEditor .optionA,
.xeEditor .optionB,
.xeEditor .optionC { float:left; background:#ffffff url(/xe/modules/editor/tpl/images/bgBoardEditorOption.gif) no-repeat left bottom; padding:.5em 0 .5em .7em; overflow:hidden;}
.xeEditor .optionA *,
.xeEditor .optionB *,
...
.xeEditor .textAreaDragIndicator { text-align:center; background:url(/xe/modules/editor/tpl/images/lineTextAreaDrag.gif) repeat-x left center; padding:5px 0 5px 0; }
.xeEditor .textAreaDragIndicatorBar { background:url(/xe/modules/editor/tpl/images/buttonTextAreaDrag.gif) no-repeat center; cursor:move;height:14px;}
...
.xeEditor .fileAttach .fileUploadControl .uploaderButton { display:block; cursor:pointer; background:url(/xe/modules/editor/tpl/images/buttonTypeBCenter.gif) repeat-x left center; line-height:100%; overflow:visible; color:#3f4040; margin:0 1px; font-size:.9em; white-space:nowrap;}
...
.xeEditor .fileAttach .fileUploadControl .uploaderButton .leftCap { width:2px; height:21px; background:url(/xe/modules/editor/tpl/images/buttonTypeBLeft.gif) no-repeat; margin:0 .3em 0 0;  position:relative; left:-1px;}
.xeEditor .fileAttach .fileUploadControl .uploaderButton .rightCap { width:2px; height:21px; background:url(/xe/modules/editor/tpl/images/buttonTypeBRight.gif) no-repeat; margin:0 -1px 0 .4em;}
