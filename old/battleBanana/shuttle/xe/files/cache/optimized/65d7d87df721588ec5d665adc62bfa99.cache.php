...
#xeAdmin .pagination.a1 a.prev{ padding-left:10px; background:#fff url(/xe/modules/admin/tpl/img/arrowPrevA1.gif) no-repeat left center; }
#xeAdmin .pagination.a1 a.prevEnd{ padding-left:15px; background:#fff url(/xe/modules/admin/tpl/img/arrowPrevEndA1.gif) no-repeat left center; }
#xeAdmin .pagination.a1 a.next{ padding-right:10px; background:#fff url(/xe/modules/admin/tpl/img/arrowNextA1.gif) no-repeat right center; }
#xeAdmin .pagination.a1 a.nextEnd{ padding-right:15px; background:#fff url(/xe/modules/admin/tpl/img/arrowNextEndA1.gif) no-repeat right center; }
...
#xeAdmin .pagination.a2 a.prev{ padding-left:10px; background:#fff url(/xe/modules/admin/tpl/img/arrowPrevA1.gif) no-repeat left center; }
#xeAdmin .pagination.a2 a.prevEnd{ padding-left:15px; background:#fff url(/xe/modules/admin/tpl/img/arrowPrevEndA1.gif) no-repeat left center; }
#xeAdmin .pagination.a2 a.next{ padding-right:10px; background:#fff url(/xe/modules/admin/tpl/img/arrowNextA1.gif) no-repeat right center; }
#xeAdmin .pagination.a2 a.nextEnd{ padding-right:15px; background:#fff url(/xe/modules/admin/tpl/img/arrowNextEndA1.gif) no-repeat right center; }
...
#xeAdmin .pagination.b1 a.prevEnd{ padding-left:16px; background:url(/xe/modules/admin/tpl/img/arrowPrevB1.gif) no-repeat left center; }
#xeAdmin .pagination.b1 a.next,
#xeAdmin .pagination.b1 a.nextEnd{ padding-right:16px; background:url(/xe/modules/admin/tpl/img/arrowNextB1.gif) no-repeat right center; }
...
#xeAdmin .pagination.b2 a.prevEnd{ padding-left:12px; background:url(/xe/modules/admin/tpl/img/arrowPrevB1.gif) no-repeat left center; }
#xeAdmin .pagination.b2 a.next,
#xeAdmin .pagination.b2 a.nextEnd{ padding-right:12px; background:url(/xe/modules/admin/tpl/img/arrowNextB1.gif) no-repeat right center; }
...
#xeAdmin .pagination.c1 a.prev,
#xeAdmin .pagination.c1 a.prevEnd{ background:url(/xe/modules/admin/tpl/img/arrowPrevC1.gif) no-repeat center;}
#xeAdmin .pagination.c1 a.next,
#xeAdmin .pagination.c1 a.nextEnd{ background:url(/xe/modules/admin/tpl/img/arrowNextC1.gif) no-repeat center;}
...
#xeAdmin .pagination.c2 a.prev,
#xeAdmin .pagination.c2 a.prevEnd{ background:url(/xe/modules/admin/tpl/img/arrowPrevC1.gif) no-repeat center;}
#xeAdmin .pagination.c2 a.next,
#xeAdmin .pagination.c2 a.nextEnd{ background:url(/xe/modules/admin/tpl/img/arrowNextC1.gif) no-repeat center;}
