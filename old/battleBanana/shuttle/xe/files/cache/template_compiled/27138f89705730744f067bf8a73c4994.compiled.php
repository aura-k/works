...
$oXmlFilter = new XmlJSFilter("modules/admin/tpl/./filter/","update_env_config.xml");
$oXmlFilter->compile();
?>

<?php
require_once("./classes/xml/XmlJsFilter.class.php");
$oXmlFilter = new XmlJSFilter("modules/admin/tpl/./filter/","update_lang_select.xml");
$oXmlFilter->compile();
?>

<?php
require_once("./classes/xml/XmlJsFilter.class.php");
$oXmlFilter = new XmlJSFilter("modules/admin/tpl/./filter/","install_ftp_info.xml");
$oXmlFilter->compile();
?>

<?php
require_once("./classes/xml/XmlJsFilter.class.php");
$oXmlFilter = new XmlJSFilter("modules/admin/tpl/./filter/","install_ftp_path.xml");
$oXmlFilter->compile();
?>

<?php Context::loadLang("modules/admin/tpl/../../install/lang"); ?>
<!--Meta:modules/admin/tpl/../../install/tpl/js/install_admin.js--><?php Context::addJsFile("modules/admin/tpl/../../install/tpl/js/install_admin.js", false, ""); ?>
<!--Meta:modules/admin/tpl/./js/config.js--><?php Context::addJsFile("modules/admin/tpl/./js/config.js", true, ""); ?>
...
<div class="content">
    <?php  if($__Context->logged_info->is_admin == 'Y'){ ?>
        <p class="path">
            ...
            &gt; <a href="<?php @print(getUrl('','mid',$__Context->mid,'module',$__Context->module,'act',$__Context->act));?>"><?php @print($__Context->lang->env_setup);?></a>
        </p>
    <?php  } ?>
    ...
    <tr>
        ...
        <td>
            ...
            <input type="text" name="_target_module" id="_target_module" class="inputTypeText w300" value="<?php @print($__Context->start_module->mid);?> (<?php @print(htmlspecialchars($__Context->start_module->browser_title));?>)" readonly="readonly" /><a href="<?php @print(getUrl('','module','module','act','dispModuleSelectList','id','target_module','type','single'));?>" onclick="popopen(this.href,'ModuleSelect');return false;" class="button green"><span><?php @print($__Context->lang->cmd_select);?></span></a>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="checkbox" name="use_optimizer" value="Y"  <?php  if($__Context->use_optimizer!='N'){ ?>checked="checked"<?php  } ?> />
            <p><?php @print($__Context->lang->about_optimizer);?></p>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <select name="change_lang_type">
                <?php $Context->__idx[0]=0;if(count($__Context->lang_supported))  foreach($__Context->lang_supported as $__Context->key => $__Context->val){$__Context->__idx[1]=($__Context->__idx[1]+1)%2; $__Context->cycle_idx = $__Context->__idx[1]+1; ?>
    ...
    <tr>
        ...
        <td>
            <select name="time_zone" class="fullWidth">
                <?php $Context->__idx[1]=0;if(count($__Context->time_zone_list))  foreach($__Context->time_zone_list as $__Context->key => $__Context->val){$__Context->__idx[2]=($__Context->__idx[2]+1)%2; $__Context->cycle_idx = $__Context->__idx[2]+1; ?>
    ...
    <tr>
        ...
        <td>
            <select name="use_ssl">
            <?php $Context->__idx[2]=0;if(count($__Context->lang->ssl_options))  foreach($__Context->lang->ssl_options as $__Context->key => $__Context->val){$__Context->__idx[3]=($__Context->__idx[3]+1)%2; $__Context->cycle_idx = $__Context->__idx[3]+1; ?>
...
<div class="extension e2">
    <div class="section">
        ...
        <table cellspacing="0" class="rowTable">
        <?php $Context->__idx[3]=0;if(count($__Context->langs))  foreach($__Context->langs as $__Context->key => $__Context->val){$__Context->__idx[4]=($__Context->__idx[4]+1)%2; $__Context->cycle_idx = $__Context->__idx[4]+1; ?>
        <tr>
            <td>
