...
<div id="popBody">
    ...
    <tr>
        ...
        <td class="blue">
            <?php $Context->__idx[0]=0;if(count($__Context->module_info->author))  foreach($__Context->module_info->author as $__Context->author){$__Context->__idx[1]=($__Context->__idx[1]+1)%2; $__Context->cycle_idx = $__Context->__idx[1]+1; ?>
...
<div id="popHistoryBody">
    ...
    <?php $Context->__idx[1]=0;if(count($__Context->module_info->history))  foreach($__Context->module_info->history as $__Context->history){$__Context->__idx[2]=($__Context->__idx[2]+1)%2; $__Context->cycle_idx = $__Context->__idx[2]+1; ?>
    <tr>
        <th scope="row">
