...
<!--Meta:modules/message/skins/default/message.css--><?php Context::addCSSFile("modules/message/skins/default/message.css", true, "all", ""); ?>
...
$oXmlFilter = new XmlJSFilter("modules/message/skins/default/./filter/","login.xml");
$oXmlFilter->compile();
?>

	<?php
require_once("./classes/xml/XmlJsFilter.class.php");
$oXmlFilter = new XmlJSFilter("modules/message/skins/default/./filter/","openid_login.xml");
$oXmlFilter->compile();
?>

	<!--Meta:modules/message/skins/default/./message.js--><?php Context::addJsFile("modules/message/skins/default/./message.js", true, ""); ?>
