...
/**
 * navigator 메서드는 웹 브라우저의 정보 객체를 리턴한다. (1.4.3 부터 mobile,msafari,mopera,mie 사용 가능)
...
jindo.$Agent.prototype.navigator = function() {
	...
	info.mobile	   = f("Mobile",u)||f("Android",u)||f("Nokia",u)||f("webOS",u)||f("Opera Mini",u)||f("BlackBerry",u)||f("PPC",u)||f("Smartphone",u)||f("IEMobile",u);
...
/**
 * os 메서드는 운영체제에 대한 정보 객체를 리턴한다.(1.4.3 부터 iphone,android,nokia,webos,blackberry,mwin 사용 가능.)
...
jindo.$Element.prototype._setCss = function(e, k, v){
	if (k == "cursor" && v == "pointer") {
		e.style.cursor = "hand";
	} else if (("#top#left#right#bottom#").indexOf(k+"#") > 0 && (typeof v == "number" ||(/\d$/.test(v)))) {
...
jindo.$Element.prototype.text = function(sText) {
	...
	if (typeof sText == "string" || typeof sText == "number" || typeof sText == "boolean") {
		sText += "";
		try { 
 ...
 * @remark 일반적인 이벤트와 별로로 추가적인 이벤트로는 domready, mouseenter, mouseleave, mousewheel이 있다.
