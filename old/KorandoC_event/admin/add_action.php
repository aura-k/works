<?
	...
	if (isset($_POST['title']) == TRUE && trim($_POST['title']) != '' && isset($_POST['code']) == TRUE && trim($_POST['code']) != '' && isset($_POST['url']) == TRUE && trim($_POST['url']) != '' && isset($_POST['color']) == TRUE && trim($_POST['color']) != '')
	{
		$filename = date('Ymd_His').'.itm';
