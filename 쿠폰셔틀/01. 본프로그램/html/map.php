...
<?
		$sql=mysql_query("SELECT * FROM `C_xml_datalist` as A
							where c_date = UNIX_TIMESTAMP( CURRENT_DATE( ) ) order by c_people desc") or die(mysql_error());
		$i=0;
		$cnt=0;
		$cp_num=0;
		$cp_coord=0;
		...
		while($row=mysql_fetch_array($sql)){
			...
			echo 'infowindows['.$i.'] = new DInfoWindow("http://couponshuttle.com/new/map_attri.php?cp='.$row['c_name'].'", { width: 220, height: 250 });';
...
?>
		//map.panTo(new DLatLng(37.53844004, 126.992044));
...
<script type="text/javascript"><!--
google_ad_client = "pub-1913983451013442";
/* 728x90, 작성됨 10. 8. 29 */
google_ad_slot = "0485320724";
google_ad_width = 728;
google_ad_height = 90;
//-->
</script>
