...
$oXmlFilter = new XmlJSFilter("widgets/login_info/skins/xe_official/./filter/","login.xml");
$oXmlFilter->compile();
?>

<?php
require_once("./classes/xml/XmlJsFilter.class.php");
$oXmlFilter = new XmlJSFilter("widgets/login_info/skins/xe_official/./filter/","openid_login.xml");
$oXmlFilter->compile();
?>

<!--Meta:widgets/login_info/skins/xe_official/./js/login.js--><?php Context::addJsFile("widgets/login_info/skins/xe_official/./js/login.js", true, ""); ?>
...
<form action="./" method="post" onsubmit="return procFilter(this, widget_login)" id="fo_login_widget">
    ...
    <div class="idpwWrap">
        ...
        <input type="image" src="/xe/widgets/login_info/skins/xe_official/images/<?php @print($__Context->colorset);?>/buttonLogin.gif" alt="login" class="login" />
    </div>
