...
<!--Meta:modules/editor/skins/xpresseditor/css/default.css--><?php Context::addCSSFile("modules/editor/skins/xpresseditor/css/default.css", true, "all", ""); ?>

<!--Meta:modules/editor/skins/xpresseditor/../../tpl/js/editor_common.js--><?php Context::addJsFile("modules/editor/skins/xpresseditor/../../tpl/js/editor_common.js", true, ""); ?>
...
<?php  if($__Context->colorset == "black" || $__Context->colorset == "black_texteditor" || $__Context->colorset == "black_text_nohtml" || $__Context->colorset == "black_text_usehtml"){ ?>
    <!--Meta:modules/editor/skins/xpresseditor/css/black.css--><?php Context::addCSSFile("modules/editor/skins/xpresseditor/css/black.css", true, "all", ""); ?>
...
<?php  if($__Context->colorset == "white_texteditor" || $__Context->colorset == "black_texteditor" || $__Context->colorset == "white_text_nohtml" || $__Context->colorset == "black_text_nohtml" || $__Context->colorset == "white_text_usehtml" || $__Context->colorset == "black_text_usehtml"){ ?>
    <!--Meta:modules/editor/skins/xpresseditor/js/xe_textarea.js--><?php Context::addJsFile("modules/editor/skins/xpresseditor/js/xe_textarea.js", true, ""); ?>
...
<?php  }else{ ?>
    ...
    <!--Meta:modules/editor/skins/xpresseditor/js/Xpress_Editor.js--><?php Context::addJsFile("modules/editor/skins/xpresseditor/js/Xpress_Editor.js", true, ""); ?>
    <!--Meta:modules/editor/skins/xpresseditor/js/xe_interface.js--><?php Context::addJsFile("modules/editor/skins/xpresseditor/js/xe_interface.js", true, ""); ?>
    ...
    <div class="xpress-editor <?php @print($__Context->editor_class);?>">
        ...
        <div class="tool off">
            ...
            <ul class="type">
                <li class="xpress_xeditor_ui_format">
                    <select class="xpress_xeditor_ui_format_select" disabled="disabled">
                        ...
                        <?php $Context->__idx[3]=0;if(count($__Context->lang->edit->header_list))  foreach($__Context->lang->edit->header_list as $__Context->key=>$__Context->obj){$__Context->__idx[4]=($__Context->__idx[4]+1)%2; $__Context->cycle_idx = $__Context->__idx[4]+1; ?>
                ...
                <li class="xpress_xeditor_ui_fontName">
                    <select class="xpress_xeditor_ui_fontName_select" disabled="disabled">
                        ...
                        <?php $Context->__idx[4]=0;if(count($__Context->lang->edit->fontlist))  foreach($__Context->lang->edit->fontlist as $__Context->key=>$__Context->obj){$__Context->__idx[5]=($__Context->__idx[5]+1)%2; $__Context->cycle_idx = $__Context->__idx[5]+1; ?>
            ...
            <ul class="extra1">
                ...
                <li class="find xpress_xeditor_ui_findAndReplace">
                    <button type="button" title="<?php @print($__Context->lang->cmd_find);?>"><span><?php @print($__Context->lang->cmd_find);?></span></button>
                    <!-- 찾기 바꾸기 레이어 -->
                    <div class="layer find xpress_xeditor_findAndReplace_layer" style="display:none">
                    <!-- class="layer find" | class="layer replace"-->
                        <h3><?php @print($__Context->lang->edit->search_replace);?></h3>
                        <button type="button" class="close" title="<?php @print($__Context->lang->edit->close_search_replace);?>"><span><?php @print($__Context->lang->edit->close_search_replace);?></span></button>
                        <div class="menu_tab">
                            <ul class="layer_tab">
                                <li class="tab1"><a href="#find" onclick="return false"><?php @print($__Context->lang->cmd_find);?></a></li>
                                <li class="tab2"><a href="#replace" onclick="return false"><?php @print($__Context->lang->cmd_replace);?></a></li>
                            </ul>
                        </div>
                        <div class="container">
                            <div class="bx" id="find">
                                <fieldset>
                                    <label for="keyword1"><?php @print($__Context->lang->edit->search_words);?></label>
                                    <input id="keyword1" name="" type="text" />
                                </fieldset>
                                <span class="cap"></span> </div>
                            <div class="bx" id="replace">
                                <fieldset>
                                    <label for="keyword2"><?php @print($__Context->lang->edit->search_words);?></label>
                                    <input id="keyword2" name="" type="text" />
                                    <br />
                                    <label for="keyword3"><?php @print($__Context->lang->edit->replace_words);?></label>
                                    <input id="keyword3" name="" type="text" />
                                </fieldset>
                            </div>
                        </div>
                        <div class="btn_area">
                            <button type="button" class="find_next" title="<?php @print($__Context->lang->edit->next_search_words);?>"><span><?php @print($__Context->lang->edit->next_search_words);?></span></button>
                            <button type="button" class="replace" title="<?php @print($__Context->lang->cmd_replace);?>"><span><?php @print($__Context->lang->cmd_replace);?></span></button>
                            <button type="button" class="replace_all" title="<?php @print($__Context->lang->edit->replace_all);?>"><span><?php @print($__Context->lang->edit->replace_all);?></span></button>
                        </div>
                        <button type="button" class="close" title="<?php @print($__Context->lang->edit->close_search_replace);?>"><span><?php @print($__Context->lang->edit->close_search_replace);?></span></button>
                    </div>
                    <!-- /찾기 바꾸기 레이어 -->
                ...
                <li class="extensions xpress_xeditor_ui_extension">
                    ...
                    <div class="layer extension2 xpress_xeditor_extension_layer" id="editorExtension_<?php @print($__Context->editor_sequence);?>">
                        <ul id="editor_component_<?php @print($__Context->editor_sequence);?>" class="editorComponent">
                            <?php $Context->__idx[5]=0;if(count($__Context->component_list))  foreach($__Context->component_list as $__Context->component_name => $__Context->component){$__Context->__idx[6]=($__Context->__idx[6]+1)%2; $__Context->cycle_idx = $__Context->__idx[6]+1; ?>
                                <li><?php  if($__Context->component->component_icon){ ?><img src="/xe/modules/editor/components/<?php @print($__Context->component_name);?>/component_icon.gif" alt="" width="13" height="12"/> <?php  } ?><a href="#" onclick="return false;" id="component_<?php @print($__Context->editor_sequence);?>_<?php @print($__Context->component_name);?>"><?php @print($__Context->component->title);?></a></li>
                            <?php  } ?>
                        </ul>
                    </div>
                </li>
        ...
        <?php  if($__Context->allow_fileupload){ ?>
            <!--Meta:modules/editor/skins/xpresseditor/../../tpl/js/uploader.js--><?php Context::addJsFile("modules/editor/skins/xpresseditor/../../tpl/js/uploader.js", true, ""); ?>
            <!--Meta:modules/editor/skins/xpresseditor/../../tpl/js/swfupload.js--><?php Context::addJsFile("modules/editor/skins/xpresseditor/../../tpl/js/swfupload.js", true, ""); ?>
            <script type="text/javascript">//<![CDATA[
            editorUploadInit(
                {
