...
.login_default form p.noneSSL { background:url(/xe/widgets/login_info/skins/xe_official/images/none_ssl.png) no-repeat left top; }
.login_default form p.SSL { background:url(/xe/widgets/login_info/skins/xe_official/images/ssl.png) no-repeat left top; }
...
.login_default form ul.userMenu li { list-style:none; padding-left:10px; background:url(/xe/widgets/login_info/skins/xe_official/images/default/bulletFF1A00.gif) no-repeat left 4px;  margin-bottom:5px;}
...
.openid_login_default form .idpw p { margin:0; padding:0; margin-bottom:5px; background: url(/xe/widgets/login_info/skins/xe_official/images/openid_login_bg.gif) left no-repeat; padding-left:18px; font-size:.9em Tahoma;color:#999999}
