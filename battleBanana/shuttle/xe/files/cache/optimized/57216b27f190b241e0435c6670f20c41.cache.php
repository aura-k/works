...
#xeAdmin .header{ position:relative; height:62px; padding:10px 15px 10px 30px; background:url(/xe/modules/admin/tpl/img/bgHeader.gif) repeat-x; z-index:10;}
#xeAdmin .footer{ height:26px; padding-top:10px; background:url(/xe/modules/admin/tpl/img/bgFooter.gif) repeat-x; text-align:center;}
...
.body{ position:relative; margin:0; padding:20px 0 20px 200px; background:url(/xe/modules/admin/tpl/img/lineBody.gif) repeat-y 180px 0; *zoom:1;}
...
#xeAdmin .lnb li,
#xeAdmin .lnb li a{ position:relative; float:left; background:url(/xe/modules/admin/tpl/img/buttonLNB.gif) no-repeat; white-space:nowrap;}
...
#xeAdmin .path{ padding:0 0 0 25px; margin:0 0 20px 0; background:url(/xe/modules/admin/tpl/img/iconPath.gif) no-repeat left center;}
