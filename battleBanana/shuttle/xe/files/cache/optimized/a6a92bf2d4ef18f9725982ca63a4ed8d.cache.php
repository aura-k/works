...
.aside .categoryBox .bottomLine {background:transparent url(/xe/modules/autoinstall/tpl/img/hrE1.gif) repeat-x scroll left bottom;}
.aside .categoryBox .topLine {background:transparent url(/xe/modules/autoinstall/tpl/img/hrE1.gif) repeat-x scroll left top;}
...
.aside .categoryBox ul.resourceManage { margin:0; padding:10px 0 0 0; list-style:none; background:transparent url(/xe/modules/autoinstall/tpl/img/hrE1.gif) repeat-x scroll left top; }
.aside .categoryBox ul.resourceManage li { background:url(/xe/modules/autoinstall/tpl/img/btnManage.gif) no-repeat 2px 2px; padding-left:14px; white-space:nowrap; overflow:hidden; margin-bottom:10px; }
...
ul.listOrder { position:relative; overflow:hidden; margin:0; padding:10px 0; text-align:left; background:transparent url(/xe/modules/autoinstall/tpl/img/hrE1.gif) repeat-x scroll left bottom;}
ul.listOrder.asc li.arrow { background:url(/xe/modules/autoinstall/tpl/img/arrUp.gif) no-repeat right 2px; padding-right:10px; }
ul.listOrder.desc li.arrow { background:url(/xe/modules/autoinstall/tpl/img/arrDown.gif) no-repeat right 2px; padding-right:10px; }
